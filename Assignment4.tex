...
\begin{lstlisting}
https://github.com/satyam463/matrix-theory-Assignment3/blob/master/assignment3.py
\end{lstlisting}
...
\vec{V}=\myvec{1&-1\\-1&1} , \vec{u} = \myvec{1&1},f=0
\end{align}
...
\end{align}
Therefore it is parabola with vertex at (0,0).
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{para.png}
\caption{standard parabola$ y^2=4ax$}
\label{Fig}
\end{figure}
\end{document}
